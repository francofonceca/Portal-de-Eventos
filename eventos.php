            ...
            <div class="row ">
                 ...
                 <div class="col-lg-3 col-md-3 col-sm-12">
                    <select class="select-filter">
                        ...
                        <option value="DelViso">Del Viso</option>
                 ...
                 <div class="col-lg-3 col-md-3 col-sm-12">
                    <select class="select-filter">
                        ...
                        <option value="DelViso">Próximos 7 dias</option>
                 ...
                 <div class="col-lg-3 col-md-3 col-sm-12">
                    <select class="select-filter fa">
                        ...
                        <option value="DelViso">Con horario completo</option>
                 ...
                 <div class="col-lg-3 col-md-3 col-sm-12">
                    <select class="select-filter">
                        ...
                        <option value="DelViso">Casas</option>
                        <option value="GrandBourg">Salones</option>
                    </select>
                 </div>
                 <div class="container py-4 px-3 ">
                    ...
                    <div class="h100 oro100 " style="margin-top: -210px!important; opacity: 0.9;">
                        <h2 class="py-2 px-4">Corredor de Bella Vista</h2>
                        <h1 class="py-2 px-4">Running Challenge 7º edición</h1>
                    ...
                    <div class="row justify-content-evenly p-3 pb-5">
                        <div class="col-lg-6 col-md-6 col-sm-12 borde-full p-3"> 
                            ...
                            <div class="py-2">
                                <h5 class="toro">Plaza Muñiz</h5>
                                <h2 class="toro">Concierto al aire libre</h2>
                                <h6 class="textgris">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh
                                    euismod tincidunt tation ullamcorper</h6>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 borde-full p-3 mt-3">
                            ...
                            <div class="py-2">
                                <h5 class="toro">Plaza Muñiz</h5>
                                <h3 class="toro">Concierto al aire libre</h3>
                                <h6 class="textgris">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh
                                    euismod tincidunt tation ullamcorper</h6>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 borde-full p-3 mt-3">
                            ...
                            <div class="py-2">
                                <h5 class="toro">Club Bella Vista</h5>
                                <h3 class="toro">Expo Cactus 2021</h3>
                                <h6 class="textgris">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh
                                    euismod tincidunt tation ullamcorper</h6>
                                <h6 class="textgris text-strong"><strong>Pte Perón 2453, Muñiz</strong></h6>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 borde-full p-3 mt-3">
                            ...
                            <div class="py-2">
                                <h5 class="toro">Plaza San Miguel</h5>
                                <h3 class="toro">Concierto al aire libre</h3>
                                <h6 class="textgris">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh
                                    euismod tincidunt tation ullamcorper</h6>
                                <h6 class="textgris text-strong"><strong>Pte Perón 2453, Muñiz</strong></h6>
                        ...
                        <div class="col-12 pd10 gris1 bbrr ma mt-3">
                            <h5>CARGAR MÁS</h5>
                        </div>
                        <hr class="mt-2">
                    </div>
