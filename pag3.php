...
<body class="pr">
    <div class="conteiner">
        <div class="col-10  fila">
            <div class=" a1 "><img src="img/1-LOGO.png" width="100%"></div>
            <div class=" b3 fila">
                ...
                <div class="a1 centrar sub14">EMPRESAS</div>
            </div>
        </div>
        <div class=" col-10 conteiner oro100 fila">
            <div class="a0"></div>
        ...
        <div class="centrar h500 oh flores">
            <div class=" h100j col-12 oh oro60">
                <h2 class="centrar top ">Ideas & Notas</h2>
            </div>
        </div>
        <div class="col-05 top center "></div>
        <div class="col-9 h500 blanco ma center">
        ...
        <div class="col-9 top"></div>
        <div class="col-9 h300 blanco ma center">
            <div class="col-6 h200 blanco fl "></div>
            <div class="col-6 h200 blanco fl "></div>
        </div>
        <br class="top">
